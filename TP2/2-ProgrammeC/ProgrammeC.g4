...
| IF LPAR e1=expression RPAR e2=expression                                              { $inst= new If( $e1.inst, null, $e2.inst, null, new Constante(0)); }
| IF LPAR e1=expression RPAR e2=expression ELSE e3=expression                           { $inst= new If( $e1.inst, null, $e2.inst, $e3.inst, new Constante(0)); }
| IF LPAR e1=expression op=variable e2=expression RPAR e3=expression                    { $inst= new If( $e1.inst, $e2.inst, $e3.inst, null, $op.cons ); }
...
| WHILE LPAR e1=expression RPAR e2=expression                                           { $inst= new While( $e1.inst, null, $e2.inst, new Constante(0) ); }
| WHILE LPAR e1=expression op=variable e2=expression RPAR e3=expression                 { $inst= new While( $e1.inst, $e2.inst, $e3.inst, $op.cons ); }
...
variable returns [ Constante cons ] :
  DIFF  { $cons = new Constante(0); }
| EQUAL { $cons = new Constante(1); }
