...
public interface ProgrammeCListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ProgrammeCParser#variable}.
	 * @param ctx the parse tree
	 */
	void enterVariable(ProgrammeCParser.VariableContext ctx);
	/**
	 * Exit a parse tree produced by {@link ProgrammeCParser#variable}.
	 * @param ctx the parse tree
	 */
	void exitVariable(ProgrammeCParser.VariableContext ctx);
}